...
if __name__ == '__main__':
    ...
    _keep_words = [word for word in counts if counts[word] >= 100]
    print("Running SVD..")
    run("/dfs/scratch0/COHA/cooccurs/lemma/testb-0-ppmi.bin.bin", "/dfs/scratch0/COHA/cooccurs/lemma/testb-0-svd",
        keep_words=_keep_words)
